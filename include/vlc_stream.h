...
VLC_API int vlc_stream_vaControl(stream_t *s, int query, ...);
 ...
 */
VLC_USED int vlc_stream_GetSize( stream_t *s, uint64_t *size )
{
...
VLC_USED
bool stream_HasExtension( stream_t *s, const char *extension )
{
 ...
 */
char *stream_ContentType( stream_t *s )
{
    char *res;
 ...
 **/
VLC_USED
char *stream_MimeType( stream_t *s )
{
